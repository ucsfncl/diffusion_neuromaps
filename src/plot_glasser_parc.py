...
if __name__ == "__main__":
    ...
    os.makedirs("diffusion_neuromaps/data/glasser/ave", exist_ok=True)
    os.makedirs("diffusion_neuromaps/data/glasser/retest_ave", exist_ok=True)
    os.makedirs("diffusion_neuromaps/data/glasser/li", exist_ok=True)
    os.makedirs("diffusion_neuromaps/data/glasser/retest_cov", exist_ok=True)
    os.makedirs("diffusion_neuromaps/data/glasser/intersubject_cov", exist_ok=True)
    os.makedirs("diffusion_neuromaps/data/glasser/icc", exist_ok=True)
